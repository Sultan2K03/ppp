  ...
  <body>
    ...
    <div class="wrapper">
      ...
      >
        <nav class="navbar navbar-expand w-100 p-0 gap-3 align-items-center">
          ...
          <div class="shop-category col-10" style="text-align: center">
            <h6 class="mb-0 fw-bold text-dark">Study Material</h6>
          </div>
          <div class="col-1"></div>
      ...
      <div class="page-content">
       <div class="row row-cols-sm-12 row-cols-lg-12 row-cols-md-12">
        <div class="col">
          <h1 class="text-center">Course Related PDFs</h1>
            <object data="Accountancy_SrSec_2022-23.pdf" style="height:20rem; width:100%;"type="application/pdf"></object>
        </div>
       </div>
       <hr>
       <div class="row row-cols-sm-12 row-cols-lg-12 row-cols-md-12">
          <div class="col">
            <h1 class="text-center">Course Related Videos</h1>
            <iframe height="100%" width="100%" src="https://www.youtube.com/embed/cnwuYeCqni0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
          </div>
       </div>
      </div>
      <!--end to page content-->
