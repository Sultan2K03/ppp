...
<!-- Mirrored from codervent.com/mobile/synrok/demo/contact-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 15 Jul 2023 13:59:03 GMT -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Synrok - eCommerce Mobile HTML Template</title>
    ...
    <div class="wrapper">
       ...
       <header class="top-header fixed-top border-bottom d-flex align-items-center">
        <nav class="navbar navbar-expand w-100 p-0 gap-3 align-items-center">
          <!-- <div class="nav-button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasSidenav"><a href="javascript:;"><i class="bi bi-list"></i></a></div> -->
            ...
            <div class="contact-us col-10" style="text-align:center;">
     ...
     <!--start to footer-->
      <footer class="page-footer fixed-bottom border-top d-flex align-items-center justify-content-center gap-3">
        <a href="javascript:;" class="btn btn-ecomm rounded-3 btn-dark flex-fill"><i class="bi bi-send me-2"></i>Send Message</a>
      </footer>
       <!--end to footer-->
