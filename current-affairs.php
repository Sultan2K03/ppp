      ...
      >
        <nav class="navbar navbar-expand w-100 p-0 gap-3 align-items-center">
          ...
          <div class="shop-category col-10" style="text-align: center">
            <h6 class="mb-0 fw-bold text-dark">Current Affairs</h6>
          </div>
          <div class="col-1"></div>
            ...
            <a href="" style="display: flex; justify-content: center">
              <div class="card" style="width: 18rem; margin-bottom: 1.5rem; ">
                <div class="card-img d-flex justify-content-center">
                  <img
                    src="assets/images/current-affairs/CA.jpg"
                    style="width: 8rem; margin-top: 1rem; width: 8rem; margin-top: 1rem; border-radius: 100px; filter: drop-shadow(2px 4px 6px #a7a7a7);"
                    class="card-img-top"
                    alt="..."
                  />
                </div>
                <div class="card-body">
                  ...
                  <p class="card-text" style="height: 4rem; overflow: auto">
                    The description about the current affair will be shown here.
                  </p>
                </div>
              </div>
            </a>
