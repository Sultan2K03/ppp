                ...
                <div class="card-body">
                   <div class="d-flex flex-row align-items-center justify-content-between gap-2">
                      <div class="category-name">
                        <h6 class="mb-0 fw-bold text-dark fs-5">Men</h6>
                      </div>
                      <div class="category-img">
                        <img src="assets/images/circular-category/01.webp" class="img-fluid" width="100" alt=""/>
                       </div>
                   </div>
                </div>
              </div>
          ...
          <div class="col">
            ...
            <div class="card rounded-3 mb-0">
              <div class="card-body">
                 <div class="d-flex flex-row align-items-center justify-content-between gap-2">
                    <div class="category-name">
                      <h6 class="mb-0 fw-bold text-dark fs-5">Women</h6> 
                    </div>
                    <div class="category-img">
                      <img src="assets/images/circular-category/02.webp" class="img-fluid" width="100" alt=""/>
                     </div>
                 </div>
              </div>
            </div>
          ...
          <div class="col">
            ...
            <div class="card rounded-3 mb-0">
              <div class="card-body">
                 <div class="d-flex flex-row align-items-center justify-content-between gap-2">
                    <div class="category-name">
                      <h6 class="mb-0 fw-bold text-dark fs-5">Kids</h6>
                    </div>
                    <div class="category-img">
                      <img src="assets/images/circular-category/03.webp" class="img-fluid" width="100" alt=""/>
                     </div>
                 </div>
              </div>
            </div>
          ...
          <div class="col">
            ...
            <div class="card rounded-3 mb-0">
              <div class="card-body">
                 <div class="d-flex flex-row align-items-center justify-content-between gap-2">
                    <div class="category-name">
                      <h6 class="mb-0 fw-bold text-dark fs-5">Mobiles</h6>
                    </div>
                    <div class="category-img">
                      <img src="assets/images/circular-category/04.webp" class="img-fluid" width="100" alt=""/>
                     </div>
                 </div>
              </div>
            </div>
          ...
          <div class="col">
            ...
            <div class="card rounded-3 mb-0">
              <div class="card-body">
                 <div class="d-flex flex-row align-items-center justify-content-between gap-2">
                    <div class="category-name">
                      <h6 class="mb-0 fw-bold text-dark fs-5">Laptops</h6>
                    </div>
                    <div class="category-img">
                      <img src="assets/images/circular-category/05.webp" class="img-fluid" width="100" alt=""/>
                     </div>
                 </div>
              </div>
            </div>
          ...
          <div class="col">
            ...
            <div class="card rounded-3 mb-0">
              <div class="card-body">
                 <div class="d-flex flex-row align-items-center justify-content-between gap-2">
                    <div class="category-name">
                      <h6 class="mb-0 fw-bold text-dark fs-5">Furniture</h6>
                    </div>
                    <div class="category-img">
                      <img src="assets/images/circular-category/06.webp" class="img-fluid" width="100" alt=""/>
                     </div>
                 </div>
              </div>
            </div>
          ...
          <div class="col">
            ...
            <div class="card rounded-3 mb-0">
              <div class="card-body">
                 <div class="d-flex flex-row align-items-center justify-content-between gap-2">
                    <div class="category-name">
                      <h6 class="mb-0 fw-bold text-dark fs-5">Shoes</h6>
                    </div>
                    <div class="category-img">
                      <img src="assets/images/circular-category/07.webp" class="img-fluid" width="100" alt=""/>
                     </div>
                 </div>
              </div>
            </div>
          ...
          <div class="col">
            ...
            <div class="card rounded-3 mb-0">
              <div class="card-body">
                 <div class="d-flex flex-row align-items-center justify-content-between gap-2">
                    <div class="category-name">
                      <h6 class="mb-0 fw-bold text-dark fs-5">Headphones</h6>
                    </div>
                    <div class="category-img">
                      <img src="assets/images/circular-category/08.webp" class="img-fluid" width="100" alt=""/>
                     </div>
                 </div>
              </div>
            </div>
